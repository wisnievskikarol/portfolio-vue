...
const jobs: Job[] = [
  ...
  },
  {
    ...
    companyName: 'Frontend Developer (React)',
...
<template>
  <Section id="experience" title="💼 experience">
    <ul class="text-darkGray border-gray-900 p-4 flex gap-16 flex-col rounded-md">
      <ExperienceItem
