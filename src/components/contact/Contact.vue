      ...
      <div class="flex flex-col gap-12">
        ...
        <div class="contact-line flex items-center gap-8 mt-6">
          <a
            ...
            target="_blank"
            class="group inline-flex items-center gap-2.5 text-white/20 hover:text-white/70 transition-all duration-500 text-[11px] uppercase tracking-[0.3em]"
          >
            <svg
          ...
          <span class="w-px h-4 bg-white/[0.06]" />
          <a
